...
% ## Input Arguments
%
% **x** — Input data. Can be a vector, matrix, or N-D array. All
...
% arise.
%
% **a** — Lower bound of the target range. Defaults to `0`.
%
% **b** — Upper bound of the target range. Defaults to `1`. If `b < a`,
% the output is reversed (maximum of `x` maps to `a`).
%
% ## Output Arguments
%
