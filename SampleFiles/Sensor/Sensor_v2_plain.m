...
% See also datetime, timetable
    ...
    methods
        ...
        % and type.
        %
        % s = Sensor(name, type, Units=u) also specifies the measurement
        % units.
            arguments
        ...
        % records the timestamp.  The stored value is adjusted by the
        % calibration offset.
            arguments
                obj
        ...
        %
        % s = calibrate(s, knownValue) computes a zero-offset correction
        % so that future readings align with the known reference value.
            arguments
                obj
